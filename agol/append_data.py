...
# Set Variables
accountConnection = '\\\\Location\Of\JSON\\\IowaDOT_SODA@AGOL.json'
append_layer_itemid = '6d4d21abb46e4c6fbabd8421f9300ace'
sourcefile = '/\\Location\of\temp\fgdb\Test_AVL_Images_Past_1HR.gdb.zip'
item_prop = {'title':'Temp append file for Test_AVL_Images_Past_1HR', 'type':'File Geodatabase'}
source_table_nm = 'Plowcam_Images_For_Past_Hour'
restURL='https://services.arcgis.com/8lRhdTsQyJpO52F1/arcgis/rest/admin/services/Test_AVL_Images_Past_1HR/FeatureServer/0/truncate' #modify URL for the admin url of the layer you're updating
